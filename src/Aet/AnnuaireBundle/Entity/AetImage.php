...
use Aet\CommunicationBundle\Entity\Image as BaseAetSiteImage;
 ...
 * AetImage
 *
 * @ORM\Table(name="aet_user_image")
 * @ORM\Entity(repositoryClass="Aet\AnnuaireBundle\Entity\AetImageRepository")
 * @ORM\HasLifecycleCallbacks
 */
//class AetImage extends BaseAetSiteImage
class AetImage
{
     /**
     * @var integer
    ...
    protected $defaultFileName = "defaultAvatar.jpg";
    protected $defaultAlt = "Default Avatar";
    protected $defaultImageRootDir = 'bundles/aetannuaire/images';
    protected $defaultRootDir = 'uploads/img/aetUserImg';
