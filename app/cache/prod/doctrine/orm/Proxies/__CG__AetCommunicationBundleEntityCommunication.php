...
namespace Proxies\__CG__\Aet\CommunicationBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Communication extends \Aet\CommunicationBundle\Entity\Communication implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Communication' . "\0" . 'id', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Communication' . "\0" . 'title', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Communication' . "\0" . 'shortDesc', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Communication' . "\0" . 'date', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Communication' . "\0" . 'body', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Communication' . "\0" . 'categories', 'thread', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Communication' . "\0" . 'tempThreadId', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Communication' . "\0" . 'image', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Communication' . "\0" . 'user');
        }
