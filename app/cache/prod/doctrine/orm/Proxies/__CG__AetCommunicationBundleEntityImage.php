 ...
 */
class Image extends \Aet\CommunicationBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Image' . "\0" . 'file', 'defaultFileName', 'defaultAlt', 'defaultImageRootDir', 'defaultRootDir', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Image' . "\0" . 'tempFilename', '' . "\0" . 'Aet\\CommunicationBundle\\Entity\\Image' . "\0" . 'resetImage');
        }
