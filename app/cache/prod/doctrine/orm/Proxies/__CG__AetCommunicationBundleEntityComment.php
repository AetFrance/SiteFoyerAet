 ...
 */
class Comment extends \Aet\CommunicationBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'thread', 'author', 'rawBody', 'ancestors', 'parent', 'body', 'depth', 'createdAt', 'state', 'previousState');
        }
    ...
    public function getRawBody()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRawBody', array());
    ...
    public function setRawBody($rawBodyData)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRawBody', array($rawBodyData));

        return parent::setRawBody($rawBodyData);
    }
