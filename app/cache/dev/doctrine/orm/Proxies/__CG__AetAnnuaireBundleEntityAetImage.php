 ...
 */
class AetImage extends \Aet\AnnuaireBundle\Entity\AetImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Aet\\AnnuaireBundle\\Entity\\AetImage' . "\0" . 'id', '' . "\0" . 'Aet\\AnnuaireBundle\\Entity\\AetImage' . "\0" . 'alt', '' . "\0" . 'Aet\\AnnuaireBundle\\Entity\\AetImage' . "\0" . 'url', '' . "\0" . 'Aet\\AnnuaireBundle\\Entity\\AetImage' . "\0" . 'file', '' . "\0" . 'Aet\\AnnuaireBundle\\Entity\\AetImage' . "\0" . 'resetImage', 'defaultFileName', 'defaultAlt', 'defaultImageRootDir', 'defaultRootDir', '' . "\0" . 'Aet\\AnnuaireBundle\\Entity\\AetImage' . "\0" . 'tempFilename');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AetImage $proxy) {
    ...
    public function setResetImage($resetImageVal)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setResetImage', array($resetImageVal));

        return parent::setResetImage($resetImageVal);
    }
    ...
    public function getResetImage()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getResetImage', array());

        return parent::getResetImage();
    }
